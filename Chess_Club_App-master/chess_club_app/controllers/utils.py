...
def cls():
    """Clears the terminal"""
    # Nettoyer le terminal en fonction 
    os.system("cls" if os.name == "nt" else "clear")


def date_today():
    """Returns current date in format: DD.MM.YYYY"""
    # strftime() permet de formater un objet date en chaine de caractère
...
def date_range(start_date, end_date):
    ...
    # strptime() permet de formater une chaine de caractère en objet date
    ...
    for date in range(delta.days + 1):
        # timedelteta() permet de manipuler les durées et  intervalles de temps 
        day = s_date_obj + datetime.timedelta(days=date)
        #  ajout et conversion obj date en chaine de caracteres dans laliste 
