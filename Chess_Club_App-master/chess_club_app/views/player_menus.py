...
class AddNewPlayer:
    ...
    def check_details(self):
        ...
        if input(f"{self.spacer}"
            ...
            sleep(3) # le programme se met en pause pendant 3s
            PlayerMenu()
        else:
            PlayerMenu()
...
class ShowAllPlayers:
    ...
    def sort_by_id(self):
        ...
        # "pass" permet d'ignorer  la fonction sans lever d'erreur
        # "pass" peut etre utilisé   pour définir  une fonction en attente de développement
        pass
...
class SearchPlayer:
    ...
    def search_for(self, dict_key: str):
        ...
        if dict_key == "doc_id":
            ...
            if len(matches) == 0:
                print(f"{self.spacer}"
                    #   title() est une methode de chaines de caractères qui permet d'écrire les premières lettres des mots d'une chaines de caractères en majuscule
                ...
                id_num = ""
                # isnumeric() est une methode de chaine de caractères qui permet de vérifier que tous les caractères d'une chaine sont des chiffres
