...
class MenuScreen:
    ...
    def __init__(
        ...
        # \ indique que la ligne se poursuit à la ligne suivante
    ...
    def user_action(self):
        ...
        while not valid_menu_choice(answer, self.opt_num):
            # \033[F : code échappement ANSI qui permet de déplacer le curseur d'une ligne vers le haut et afficher la commande précédente
            # F pour Forward(en avant)
            #   ANSI code escape : une sequence de caractère spéciaux qui permet de controler l'affichage de texte dans les terminaux
            answer = input(
